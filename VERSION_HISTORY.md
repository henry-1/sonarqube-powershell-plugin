...
| # | Feature | Description |
| --- | --- | --- |
| 1 | SonarQube | PSScriptAnalyzer Tests and their Details can be loaded into SonarQube via XML File  |
...
| # | Feature | Description |
| --- | --- | --- |
| 1 | PSScriptAnalyzer | PSScriptAnalyzer will be invoked and Results are transferred to SonarQube |
| | | There are 3 pre-defined Rules in SonarQube and PSScriptAnalayzer Findings are matched by Severity. |
| 2 | Pester | Pester can optionally be invoked and Results are transferred to SonarQube |
| | | - Each Line covered by  a Test is marked as covered <br>- All other lines are marked as not covered<br>- Percentage of covered and not covered Code is displayed in SonarQube |

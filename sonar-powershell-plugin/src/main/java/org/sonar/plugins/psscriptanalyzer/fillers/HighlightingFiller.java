		...
		try {
            ...
            for (final Token token : tokenList) {
            	...
            	try {
                	...
                	System.err.println(String.format("[PSA-Plugin] Exception while adding highlighting for: %s -> %s", token, e.getMessage()));  
                }
            }
        	...
        	System.err.println(String.format("[PSA-Plugin] Exception while running highlighting " + e.getMessage()));  
        }		
	}

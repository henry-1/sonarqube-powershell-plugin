Import-Module PSScriptAnalyzer
    ...
    $reportFile = "C:\DEV\sonar-ps-plugin_0.5.3\sonar-ps-plugin\sonar-ps-plugin\src\main\resources\powershell-rules.xml"
	$profileFile = "C:\DEV\sonar-ps-plugin_0.5.3\sonar-ps-plugin\sonar-ps-plugin\src\main\resources\powershell-profile.xml"
    ...
    $powershellRules += Get-ScriptAnalyzerRule -CustomRulePath "$env:PSScriptAnalyzerCustomRulePath\*.psm1"
